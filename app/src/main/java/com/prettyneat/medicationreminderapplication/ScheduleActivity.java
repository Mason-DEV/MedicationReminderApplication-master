...
public class ScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patientToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 Intent intentBack = new Intent(ScheduleActivity.this, AddMedicationActivity.class);
    ...
    public void setSchedule(View view) {
        ...
        db.addSched(sched);
        Intent intentSchedToMed = new Intent(ScheduleActivity.this, MedicationActivity.class);
